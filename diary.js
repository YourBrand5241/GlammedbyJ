...
const OWNER_PASSWORD = "glammedowner2026";

// ASSUMPTION — real opening hours not confirmed yet: Tuesday-Saturday, 9am-6pm.
const SCHEDULES = {
...
async function loadDiary() {
  ...
  if (!schedule) {
    listEl.innerHTML = "";
    messageEl.textContent = "Glammed By J isn't open on that day.";
    return;
  }
